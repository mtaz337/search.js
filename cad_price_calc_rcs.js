...
class PriceCalculator extends React.Component {
  ...
  CALC_RATES = {
    AIRBRINGR_TRAVELLER_FEE_USD_PER_KG : 17,
  ...
  async getJSONOrder(){
    ...
    // let extraServiceFees = 0

    // if (crrReached < this.CALC_RATES.AIRGRINR_MINCRR_USD_PER_KG){
    //   var difference = this.CALC_RATES.AIRGRINR_MINCRR_USD_PER_KG - crrReached
    //   extraServiceFees = difference * maxWeight * this.EXCHANGE_RATES.USD_TO_BDT
    // }
  ...
  handleBasePriceChange(price){
    ...
    // if (crrReached < this.CALC_RATES.AIRGRINR_MINCRR_USD_PER_KG){
    //   var difference = this.CALC_RATES.AIRGRINR_MINCRR_USD_PER_KG - crrReached
    //   extraServiceFees = difference * Number(parseFloat(this.state.backpackWeightInKg).toFixed(2)) * this.EXCHANGE_RATES.USD_TO_BDT
    // }
  ...
  // handleBaseWeightInLbChange(weight){
  //   let currentWeightInLb = weight
  //   let dimentionalWeightInLb = this.state.productDimentionalWeightIn.productDimentionalWeightInLb

  //   let maxWeight = 0;
  //   let maxWeightPound = 0;

  //   if (currentWeightInLb > dimentionalWeightInLb){
  //     maxWeight = currentWeightInLb
  //   } else {
  //     maxWeight = dimentionalWeightInLb
  //   }
  //   maxWeightKG = maxWeight * this.EXCHANGE_RATES.POUND_TO_KG
  ...
  handleBackpackSavingsPercentChange(percent){
    let newSavingsPercent = percent
    // let existingShippingCharge = Number(parseFloat(this.state.productShippingCharge).toFixed(2))
    // let newCheckoutPrice = existingShippingCharge + Number(parseFloat(this.state.productBasePrice).toFixed(2))
    // let backpackServiceFee = newCheckoutPrice * this.CALC_RATES.BACKPACK_SERVICE_FEE_PERCENT / 100
    // let backpackCheckoutPrice = newCheckoutPrice + newCheckoutPrice * this.CALC_RATES.BACKPACK_US_SALES_TAX_PERCENT / 100
    ...
    // This Function is forked from handleBasePriceChange and savings calculation starts here
    let amountToReduce = Number(parseFloat(this.state.airbringrProductPriceBDT).toFixed(2)) + Number(parseFloat(this.state.airbringrTravellerFeeBDT).toFixed(2)) + newSavingsPercent/100*Number(parseFloat(this.state.backpackTotalBDT).toFixed(2))

    let airbringrServiceFee = Number(parseFloat(this.state.backpackTotalBDT).toFixed(2)) - amountToReduce
    // airbringrServiceFee = airbringrServiceFee < 0 ? airbringrServiceFee * (-1) : airbringrServiceFee
    ...
    <option value="USA" >USA</option>
      ...
      <div className="form-control btn btn-light col-md-2 change-origin" style={{float: "left"}}>Change</div>
                    ...
                    <div className="form-group m-form__group">
                      ...
                      <input type='text' className='form-control col-md-10 shoppernotefield' name="product_main_img" defaultValue={this.state.jsonOrder.customer_note}  style={{fontSize : 14, float:"left"}} disabled="disabled"/>
               ...
               <div className="col-md-4"  style={{borderRight: 1, borderLeft: 0, borderTop: 0, borderBottom: 0, borderColor : "black", borderStyle : "solid"}}>
                ...
                <div className="m-section__content">
                  ...
                  <div className="form-group m-form__group" style={{height : 50}}>
                      <h5 style={{width: 180, justifyContent : "left"}}>BASE Price : </h5>
                      <input type='text' className='form-control col-md-5' name="base_price_usd" defaultValue={this.state.jsonOrder.product_base_price_usd} step="0.01" onChange={e =>  this.handleBasePriceChange(e.target.value || 0) } style={{fontSize : 14}}/>
                    </div>
                    ...
                    <div className="form-group m-form__group" style={{height : 50}}>
                      ...
                      <input type='text' className='form-control col-md-5' name="backpack_savings_percent" defaultValue={Number(parseFloat(this.state.backpackSavingsPercent).toFixed(2))} step="0.01" onChange={e =>  this.handleBackpackSavingsPercentChange(e.target.value || 0) } style={{fontSize : 14}}/>
                    </div>
