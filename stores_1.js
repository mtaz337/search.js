...
const StoresComponent = {
        ...
        uk: [
            {
                ...
                answer: 'Yes, some products are cheaper to buy from the UK. Products that are heavier or bigger in size are actually cheaper to buy from the UK. For eg. shoes, clothes, books, supplements, beauty products etc. If you want to know the exact price, please paste the link of the product in our search bar.'
            },
            {
                question: 'What is the pound(£) conversion rate for UK products?',
                answer: 'We take the standard 135tk/£ and a small carrier charge is added on that depending on the weight of the product. You’ll get to see the total cost before making the payment.'
            },
            {
                question: 'Do I have to pay any additional charge (eg. customs fee, weight charge) after the product arrives?',
                answer: 'No, you don’t have to pay anything extra after your initial payment. We’ll calculate all the charges (including customs fee and weight charge) beforehand and show you the total in checkout.'
            },
            {
            ...
            },
            {
                ...
                answer: 'We don’t have warranty/return service for UK stores yet, but we do hope to start soon. In the meantime, we’ll help you get products from good sellers so that you get high quality products.'
            },
            {
                question: 'How to find and order items?',
                answer: 'It’s very easy, you can find the product link from any UK website, paste it on our search bar and we’ll let you know the price within few hours. After that you can take the item to checkout and pay with any of the payment options you like. And your order is placed!'
            },
        ],
        cad: [
            {
                question: 'Is it cheaper to buy good quality products from the canada?',
                answer: 'Yes, some products are cheaper to buy from the canada. Products that are heavier or bigger in size are actually cheaper to buy from the canada. For eg. shoes, clothes, books, supplements, beauty products etc. If you want to know the exact price, please paste the link of the product in our search bar.'
            },
            {
                question: 'What is the pound(£) conversion rate for canada products?',
                answer: 'We take the standard 120tk/£ and a small carrier charge is added on that depending on the weight of the product. You’ll get to see the total cost before making the payment.'
            },
            {
                question: 'Do I have to pay any additional charge (eg. customs fee, weight charge) after the product arrives?',
                answer: 'No, you don’t have to pay anything extra after your initial payment. We’ll calculate all the charges (including customs fee and weight charge) beforehand and show you the total in checkout.'
            ...
            },
            {
                ...
                answer: 'We don’t have warranty/return service for canada stores yet, but we do hope to start soon. In the meantime, we’ll help you get products from good sellers so that you get high quality products.'
            },
            {
                question: 'How to find and order items?',
                answer: 'It’s very easy, you can find the product link from any canada website, paste it on our search bar and we’ll let you know the price within few hours. After that you can take the item to checkout and pay with any of the payment options you like. And your order is placed!'
            },
        ],
        uae: [
            {
    ...
    stores: {
        ...
        { 
            ...
            {
                id: 3,
                logo: 'image/store/usa/guess1.png',
                title: 'guess1',
                filename:"guess1",
            ...
            },
            {
                ...
                filename:"Victoria-Secret-Logo",
                logo: "image/store/usa/Victoria-Secret-Logo.png",
                link: "https://www.victoriassecret.ca/"
            },
            {
                id: 6,
                logo: 'image/store/usa/aldo.png',
                title: 'aldo',
                link: 'https://www.aldoshoes.com/ca/en'
            },
            {
                id: 7,
                logo: 'image/store/usa/pink.jpeg',
                title: 'pink',
                link: 'https://www.victoriassecret.com/ca/pink'
            },
            {
                id: 8,
                logo: 'image/store/usa/thebodyshop.png',
                title: 'bodyshop',
                link: 'https://www.thebodyshop.com/en-ca/'
            },
            {
                id: 9,
                logo: 'image/store/usa/bath.png',
                title: 'bathandbody',
                link: 'https://www.bathandbodyworks.ca/'
            },
            {
                id: 9,
                logo: 'image/store/usa/tommy.svg',
                title: 'Tommy Hilfiger',
                link: 'https://usa.tommy.com/en'
            },
            {
                id: 4,
                title: "Nike US", 
            ...
            { 
                ...
                title: "Puma", 
                filename:"puma",
                logo: "image/store/usa/puma.jpg",
                link: "https://ca.puma.com/ca/en" 
            },
            {
                id: 9,
                logo: 'image/store/usa/nyx.png',
                title: 'nyx',
                link: 'https://www.nyxcosmetics.ca/'
            },
            {
                id: 11,
                title: "Sephora USA", 
                filename:"sephora",
                logo: "image/store/usa/sephora.png",
                link: "https://www.sephora.com/?country_switch=ca&lang=en" 
            },
            {
                id: 18,
            title: "MAC", 
            ...
            { 
                ...
                title: "ck", 
                filename: "ck",
                logo: "image/store/usa/ck.png",
                link: "https://www.calvinklein.ca/en" 
            },
            { 
                id: 3,
                title: "gnc", 
                filename: "gnc",
                logo: "image/store/usa/gnc.jpg",
                link: "https://gnc.ca/" 
            },
            { 
                id: 3,
                title: "miniso", 
                filename: "miniso",
                logo: "image/store/usa/miniso.jpeg",
                link: "http://miniso.ca/" 
            },
