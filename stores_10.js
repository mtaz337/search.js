...
const StoresComponent = {
  ...
  queries: {
    ...
    uae: [
      {
        question: "Is it cheaper to buy good quality products from the UAE?",
        answer:
          "Yes, some products are cheaper to buy from the UAE. Products that are heavier or bigger in size are actually cheaper to buy from the UAE. For eg. shoes, clothes, books, supplements, beauty products etc. If you want to know the exact price, please paste the link of the product in our search bar.",
      },
      {
        question: "What is the AED( د.إ ) conversion rate for UAE products?",
        answer:
          "We take the standard 30tk/AED and a small carrier charge is added on that depending on the weight of the product. You’ll get to see the total cost before making the payment.",
      },
      {
        question:
          "Do I have to pay any additional charge (eg. customs fee, weight charge) after the product arrives?",
      ...
      {
        question: "Do you have warranty/return service for UAE stores?",
        answer:
          "We don’t have warranty/return service for UAE stores yet, but we do hope to start soon. In the meantime, we’ll help you get products from good sellers so that you get high quality products.",
      },
      {
        question: "How to find and order items?",
        answer:
          "It’s very easy, you can find the product link from any UAE website, paste it on our search bar and we’ll let you know the price within few hours. After that you can take the item to checkout and pay with any of the payment options you like. And your order is placed!",
      },
    ],
  },
