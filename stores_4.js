...
const StoresComponent = {
    ...
    queries: {
        ...
        can: [
            ...
            {
                question: 'What is the CAN($) conversion rate for canada products?',
                answer: 'We take the standard 87tk/$ and a small carrier charge is added on that depending on the weight of the product. You’ll get to see the total cost before making the payment.'
            },
            {
                question: 'Do I have to pay any additional charge (eg. customs fee, weight charge) after the product arrives?',
                answer: 'No, you don’t have to pay anything extra after your initial payment. We’ll calculate all the charges (including customs fee and weight charge) beforehand and show you the total in checkout.'
    ...
    stores: {
        ...
        { 
            ...
            filename:"RayBan",
            logo: "image/store/usa/ray-ban.png",
            link: "https://www.ray-ban.com/canada/en/sunglasses/view-all?cid=PM-SGA_300419-3.CA-RayBan-EN-NB-Sunglasses-Broad_Sunglasses+Core_brand+sunglasses&s_kwcid=AL!16196!3!626970596128!b!!g!!brand%20sunglasses!18547051145!142430410699&gclid=Cj0KCQjwy5maBhDdARIsAMxrkw35-vGpnDvC68EYHc8PQ0RqPNN3s4_PoXJTvUwoFfpXP-4POctUXHMaAlwUEALw_wcB&gclsrc=aw.ds" 
        },
        { 
            id: 1,
            title: "Reebok", 
