    ...
    queries: {
        ...
        can: [
            ...
            },
            {
                ...
                answer: 'We take the standard 86tk/$ and a small carrier charge is added on that depending on the weight of the product. You’ll get to see the total cost before making the payment.'
            },
            {
                question: 'Do I have to pay any additional charge (eg. customs fee, weight charge) after the product arrives?',
                answer: 'No, you don’t have to pay anything extra after your initial payment. We’ll calculate all the charges (including customs fee and weight charge) beforehand and show you the total in checkout.'
            ...
            {
                question: 'How to find and order items?',
                answer: 'It’s very easy, you can find the product link from any canada website, paste it on our search bar and we’ll let you know the price within few mins(during business hours). After that you can take the item to checkout and pay with any of the payment options you like. And your order is placed!'
            },
        ],
        // uae: [
        //     {
